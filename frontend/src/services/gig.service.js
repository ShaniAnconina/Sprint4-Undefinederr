...
function _createGigs() {
    ...
    let Gigs = utilService.loadFromStorage('gigsForDemoDataAtlas')
    ...
    if (!Gigs || !Gigs.length) {
        Gigs =[
          ...
          },
          {
            ...
            "imgUrl": [
              ...
              "https://res.cloudinary.com/dr0gkmsrl/image/upload/v1674529495/demoGig/Trending/9_baijfn.jpg",
        ...
        Gigs.forEach(gig => gig.owner = getUser())

        utilService.saveToStorage('gigsForDemoDataAtlas', Gigs)
    } 
    return Gigs
}
