...
//             }
//           ]
//         Gigs.forEach(gig => gig._id = utilService.makeId())
...
//         }
//     ]
//     newGigsForDemoDate.forEach(gig => {
//         gig.owner.level = _getRandomLevel()
//         gig.reviews.forEach(review => review._id =utilService.makeId())
//     })
//     utilService.saveToStorage('newGigsForDemoDate', newGigsForDemoDate)
// }

// function _getRandomLevel() {
//     const levels = ["Top Rate Seller", "Level One", "Level Two", "New Seller"]
//     return levels[utilService.getRandomIntInclusive(0, 3)]
