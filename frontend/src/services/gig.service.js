...
function _createGigs() {
    ...
    if (!Gigs || !Gigs.length) {
        Gigs = []
        Gigs.push(_createGig('I will be your social media marketing manager',['Graphics & Design','Digital Marketing','Writing & Translation','Vodeo & Animation']))
        Gigs.push(_createGig('I will setup modern wordpress website design or blog design',['Graphics & Design','Writing & Translation','Programming & Tech']))
